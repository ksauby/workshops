...
rmarkdown::render('Rgraphics.Rmd')
...
**What to turn in: You will create the figures from Exercises I, II, and III and include them in an R markdown file. You will "knit" that R markdown file and turn that in to your TA when you are done with the lab.**
  ...
  ggplot(
	  data = <default data set>, 
        ...
        ... <other plot defaults>
         ...
         geom_<geom type>(
			 aes(
				 size = <size variable for this geom>, 
...
**You will create an R markdown file that you will "knit" later to create a HTML file to give to your TA when you are done with the lab. I suggest once you complete figure 5, knit your R markdown file to make sure that you are able to generate the HTML file. To get started, use the R markdown file here, in which I have already included the code for Figure 1 below.**

**Create each of the following figures and include **
...
2.  Overlay a *straight* smoothing line on top of the scatter plot using the *lm* method. Hint: see `?stat_smooth`.
...
We can use the function `muted` from the `scales` package to modify red and blue values.
...
Putting It All Together Challenge: Recreate This `Economist` Graph
=======================
