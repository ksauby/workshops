...
2. Download the "dataSets" and save it to the working directory you are working in in RStudio (I suggest you save it to a "Statistics_lab" folder).
...
1.  **Re-create a scatter plot with CPI on the x axis and HDI on the y axis (as you did in the previous exercise). Overlay a smoothing line on top of the scatter plot using the default method.**
